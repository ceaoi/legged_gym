...
class M20RoughCfg( LeggedRobotCfg ):
    ...
    class rewards( LeggedRobotCfg.rewards ):
        ...
        class scales():
            ...
            hip_pos = -50.0
            stand_still = -5.0
            action_amplitude = -0.2
            same_wheel_x_position = -5.0
            # feet_stumble = -0.5

            base_height = 2 # new reward for base height, -1 ~ 0
            orientation = -100
            lin_vel_z = -0.5 * 2
            ang_vel_xy = -0.5
...
class M20RoughCfgPPO( LeggedRobotCfgPPO ):  
    ...
    class runner:
        ...
        resume_path = "{LEGGED_GYM_ROOT_DIR}/logs/model/model_100.pt" # seed 2 往右倾斜？
        resume_path = "{LEGGED_GYM_ROOT_DIR}/logs/model/m20_plane/model_28000.pt" # updated from load_run and chkpt
        # resume_path = None